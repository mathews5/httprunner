...
var ImageUtils =
{
  ...
  createPngIcon : function(inputStream, mimeType, outputStream) {
    // Convert from source format to png format
    var imageTools = Cc["@mozilla.org/image/tools;1"].createInstance(Ci.imgITools);
    ...
    var encodedStream =
      imageTools.encodeScaledImage(container.value, "image/png",
