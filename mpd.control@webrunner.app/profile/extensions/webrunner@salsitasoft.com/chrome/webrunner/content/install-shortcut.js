...
//@line 28 "/home/hudson/workdir/mozilla/trunk_src/extensions/webrunner/chrome/content/install-shortcut.js"
...
Components.utils.import("resource://webrunner/modules/WebAppInstall.jsm");
Components.utils.import("resource://webrunner/modules/FaviconDownloader.jsm");
...
//@line 91 "/home/hudson/workdir/mozilla/trunk_src/extensions/webrunner/chrome/content/install-shortcut.js"
...
//@line 100 "/home/hudson/workdir/mozilla/trunk_src/extensions/webrunner/chrome/content/install-shortcut.js"
  },
  ...
  accept : function() {
    ...
    return retObj ? this.shortcutCreated(retObj.installer, retObj.shortcut, retObj.params) : false;
  },
  ...
  _handleAccept : function() {
    ...
    var params = {
        id: idPrefix + "@webrunner.app",
        name: name,
        uri: uri.value,
        icon: iconData,
        origIcon: this.getIcon(),
        status: doStatus,
        location: doLocation,
        sidebar: "false",
        trayicon: doTrayIcon};
    ...
    var installer = new WebAppInstall;
    var shortcut = installer.createShortcut(name, WebAppProperties.id, shortcuts.split(","));

    return { shortcut: shortcut, params: params, installer: installer };
  },

  shortcutCreated : function(installer, shortcut, params, mode)  {
    ...
    installer.createApplication(params, clean);

    if (this._oncomplete) {
        return this._oncomplete(WebAppProperties.id, shortcut);
    }
    return true;
  },
  ...
  onUriChange : function(event)
  {
    ...
    urlCheck.open('GET', uri.spec, true);
    urlCheck.onreadystatechange = function (aEvt) { self.onUrlChecker(urlCheck); };
    urlCheck.send(null);
  },

  onUrlChecker : function(req) {
    if (req.readyState == 4) {
      var uriBox = document.getElementById("uri");
      var uriImg = document.getElementById("uri_status");
      if(req.status == 200) {
        uriBox.setAttribute("style", "color: black;");
        uriImg.setAttribute("class", "");
      }
      else {
        uriBox.setAttribute("style", "color: red;");
        uriImg.setAttribute("class", "alert-icon");
      }
    }
  },
  ...
  useDefaultIcon : function(icon) {
    ...
    var channel = ioService.newChannel("resource://webrunner/chrome/icons/default/app.png", "", null);
  ...
  advancedSettings : function() {
    window.openDialog("chrome://webrunner/content/install-advanced.xul", "settings", "centerscreen,modal", this._advanced);
  }
};
